    ...
    return (
        <header className={`min-h-24 text-black dark:text-white lg:px-2 grid grid-cols-12 items-center border-b-2 border-b-zinc-900 lg:sticky lg:z-50 lg:top-0 bg-orange-100 dark:bg-black`}>
            ...
            <nav className={`col-span-12 lg:col-span-9 grid-cols-1 lg:grid lg:grid-cols-8 text-base lg:text-lg text-center items-center mt-3 mb-1 lg:mt-0 lg:mb-0 ${(show)? "grid" : "hidden"}`}>
                ...
                {false && <Link href = "/education" className={`p-2 flex items-center justify-center lg:rounded-t-lg h-full lg:p-4 lg:m-0 hover:bg-orange-200 lg:hover:border-b-2 lg:hover:border-b-black dark:hover:bg-zinc-900 dark:lg:hover:border-b-2 dark:lg:hover:border-b-white`}>Education</Link>}
                ...
                {false && <Link href = "/research" className={`p-2 flex items-center justify-center lg:rounded-t-lg h-full lg:p-4 lg:m-0 hover:bg-orange-200 lg:hover:border-b-2 lg:hover:border-b-black dark:hover:bg-zinc-900 dark:lg:hover:border-b-2 dark:lg:hover:border-b-white`}>Research and Awards</Link>}
