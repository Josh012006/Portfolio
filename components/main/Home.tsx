...
function Home() {
    ...
    return (
        <section id="home" className={`p-5 min-h-48 lg:min-h-125 relative overflow-hidden bg-home-light dark:bg-home-dark`}>
            <div className="p-3 text-white min-w-full absolute top-0 left-0 min-h-full flex flex-col text-center justify-center">
                ...
                <p className="whitespace-normal m-2 lg:m-5 text-sm lg:text-2xl font-bold">Software Developer | Passionate about engineering and autonomous systems</p>
            </div>
