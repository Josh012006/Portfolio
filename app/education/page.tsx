    ...
    return(
        <section id="education" className={`bg-orange-50 bg-section-light dark:bg-zinc-900 dark:bg-section-dark text-black dark:text-white p-4 min-h-125 flex flex-col items-center`}>
            ...
            <div className="p-0 lg:p-5">
                {false && <Career title="Bachelor's Degree in Computer Science (Honors, Accelerated)" logo="udem.png" period="September 2024 - August 2026" companyInfos="University of Montreal" site="https://admission.umontreal.ca/programmes/baccalaureat-en-informatique/" mail="webmestre@fas.umontreal.ca"> {/* TODO: Add GPA */}
                    I completed my Bachelor of Computer Science at the Université de Montréal while combining the Honors and Accelerated tracks, finishing the 90‑credit program typically spread over 3-4years in just 2. I finished with a GPA of /4.3. 
                    The curriculum emphasised scientific rigour and depth, covering both fundamental and advanced topics such as programming, mathematics, algorithms, data structures, software design, systems, and theoretical computer science. 
                    My accelerated path reflects both my passion for the field and my ability to manage challenging workloads effectively. It pushed me to excel in time‑management, adaptability and analytical thinking. The honors path positioned me to 
                    engage confidently into research and my area of interest-robotics.
                </Career>}
