    ...
    return(
        <section id="education" className={`bg-orange-50 dark:bg-zinc-900 ${bg}  text-black dark:text-white p-4 min-h-125 flex flex-col items-center`}>
            ...
            <div className="p-0 lg:p-5">
                <Career title="Bachelor's Degree in Computer Science (Honors, Accelerated)" logo="udem.png" period="since September 2024 (ongoing)" companyInfos="University of Montreal" site="https://admission.umontreal.ca/programmes/baccalaureat-en-informatique/" mail="webmestre@fas.umontreal.ca"> {/* TODO: Add GPA */}
                    I am currently completing a Bachelor of Computer Science at the Université de Montréal, combining both the Honors and Accelerated tracks. This 90-credit program emphasizes strong scientific rigor and depth, covering fundamental and advanced topics including programming, mathematics, algorithms, 
                    data structures, software design, systems, and theoretical computer science. The accelerated track reflects my ability to handle an intensive academic workload while maintaining a high level of performance, strengthening my time-management skills, adaptability, and analytical thinking. 
