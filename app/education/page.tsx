    ...
    return(
        <section id="education" className={`bg-orange-50 dark:bg-zinc-900 ${bg}  text-black dark:text-white p-4 min-h-125 flex flex-col items-center`}>
            ...
            <div className="p-0 lg:p-5">
                <Career title="Bachelor's Degree in Computer Science (Honors, Accelerated)" logo="udem.png" period="September 2024 - August 2026" companyInfos="University of Montreal" site="https://admission.umontreal.ca/programmes/baccalaureat-en-informatique/" mail="webmestre@fas.umontreal.ca"> {/* TODO: Add GPA */}
