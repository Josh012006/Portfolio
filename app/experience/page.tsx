    ...
    return(
        <section id="experience" className={`bg-orange-50 dark:bg-zinc-900 ${bg} text-black dark:text-white p-4 min-h-125 flex flex-col items-center`}>
            ...
            <div className="p-0 lg:p-5">
                ...
                <Career title="Internship in fullstack development at Prodigy InfoTech" logo="prodigyinfotech.png" period="August 2024 (1 month)" companyInfos="Prodigy InfoTech(Mumbai - 400018, Maharashta, India)" site="https://prodigyinfotech.dev/" mail="contact@prodigyinfotech.dev">
